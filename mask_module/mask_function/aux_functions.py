...
def line_intersection(line1, line2):
    ...
    line1 = ([line1[start][0], line1[start][1]],
...
def get_face_ellipse(face_landmark):
    ...
    a = fit_ellipse.fitEllipse(x, y)
    center = fit_ellipse.ellipse_center(a)
    phi = fit_ellipse.ellipse_angle_of_rotation(a)
    axes = fit_ellipse.ellipse_axis_length(a)
    a, b = axes
